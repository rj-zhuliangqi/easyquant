...
const navSections = computed(() => {
  ...
  const sectionDefs = [
    ...
    { label: "市场", names: ["sector-monitor", "limit-up-ladder", "opportunity-pool", "screener"] },
...
const navIcons = {
  ...
  screener: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 3H2l8 9.46V19l4 2v-8.54L22 3z"/></svg>`,
